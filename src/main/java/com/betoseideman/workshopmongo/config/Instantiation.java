package com.betoseideman.workshopmongo.config;
...
import com.betoseideman.workshopmongo.dto.AuthorDTO;
import com.betoseideman.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa Viagem Mano!", sdf.parse("24/01/2022"), new AuthorDTO(alex));
